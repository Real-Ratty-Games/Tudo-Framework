...
#define TUDO_RENDERER_MESH_STATE (BGFX_DISCARD_INDEX_BUFFER | BGFX_DISCARD_VERTEX_STREAMS | BGFX_DISCARD_STATE)
...
namespace Tudo
{
	...
	public:
		...
		void DrawMesh(uint8 flags = TUDO_RENDERER_MESH_STATE);
